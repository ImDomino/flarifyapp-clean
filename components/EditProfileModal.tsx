      ...
      <div className="bg-[#0a0a0a] border-2 border-white w-full max-w-md relative" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="p-5 space-y-5">
          ...
          <div className="flex items-center gap-4">
            <div
              className="w-20 h-20 border-2 border-zinc-700 bg-white flex items-center justify-center overflow-hidden cursor-pointer group relative"
            ...
            <div>
              ...
              <button type="button" onClick={() => fileInputRef.current?.click()} className="text-xs text-white font-bold uppercase tracking-wider mt-1 hover:underline">
                Change
              </button>
            </div>
          </div>
